...
PEANUTS_TESTER_APP_INCLUDES:=\
  $(PEANUTS_TESTER_INCLUDES:%=-I%)

$(BIN)/$(PEANUTS_TESTER_APP_NAME):\
  $(PEANUTS_TESTER_APP_OBJS)\

$(PEANUTS_TESTER_APP_TARGET): INCLUDES+=$(PEANUTS_TESTER_APP_INCLUDES)
...
PEANUTS_FUZZER_APP_INCLUDES:=\
  $(PEANUTS_FUZZER_INCLUDES:%=-I%)

$(BIN)/$(PEANUTS_FUZZER_APP_NAME):\
  $(PEANUTS_FUZZER_APP_OBJS)\

$(PEANUTS_FUZZER_APP_TARGET): INCLUDES+=$(PEANUTS_FUZZER_APP_INCLUDES)
